...
Please do **not** open a public issue for a suspected vulnerability until we have had a chance to investigate and, if needed, ship a fix.

## Supported versions

We support the latest released version of each public project. Security fixes are backported when practical; otherwise we ask you to upgrade.
